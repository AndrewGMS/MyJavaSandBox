...
public class MemoryDemo {
    public static void main(String[] args) {
        ...
        r.gc();
        mem1 = r.freeMemory();
        System.out.println("Свободной памяти плсде очистки: " + mem1);
        ...
        System.out.println("Использование памяти для выделения: " + (mem1 - mem2));
        ...
        System.out.println("Свободной памяти плсде очистки "
